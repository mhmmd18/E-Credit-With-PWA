    ...
    <div class="row">
        <div class="col-12 col-md-10">
            <div class="card py-3 px-3">
                <h6 class="py-3 bg-primary text-center text-white">Form Tambah Pembeli</h6>
                    ...
                    <div class="mt-2">
                        ...
                        <select name="smoke_id" id="smoke_id"
                            ...
                            <option style="font-size: 12px" value="{{ $smoke->id }}"
                                ...
                                {{ old('smoke_id') == $smoke->id ? 'selected' : ''}}>{{ $smoke->name }}</option>
                            @endforeach
                        </select>
                        @error('smoke_id')
